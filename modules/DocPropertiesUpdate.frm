...
Sub OpenDocumentPropertiesUpdater()
    DocPropertiesUpdate.Show
End Sub

Private Function setProperty(docProperty As String, value As String)
...
End Function
Private Function WriteCustomProp(sProp As String, sValue As String)
